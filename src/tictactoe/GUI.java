...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        agbstart = new javax.swing.JButton();
        spielenstart = new javax.swing.JButton();
        ...
        quizfeld.setLayout(null);

        quizfeldbild.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tictactoe/jeopardyfeld.png"))); // NOI18N
        quizfeld.add(quizfeldbild);
        quizfeldbild.setBounds(0, 0, 528, 496);

        agbstart.setText("jButton1");
        agbstart.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agbstartActionPerformed(evt);
            }
        });
        quizfeld.add(agbstart);
        agbstart.setBounds(190, 380, 73, 23);

        spielenstart.setText("jButton2");
        spielenstart.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                spielenstartActionPerformed(evt);
            }
        });
        quizfeld.add(spielenstart);
        spielenstart.setBounds(310, 370, 110, 40);
        ...
        hintergrundmusik.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.CTRL_MASK));
        ...
        setSize(new java.awt.Dimension(753, 555));
...
//Maybe This Time, JR Tundra
    ...
    private void hintergrundmusikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hintergrundmusikActionPerformed
        InputStream in;
        try {
            in = new FileInputStream(new File("song.wav"));
    ...
    private void uberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uberActionPerformed
        JOptionPane.showMessageDialog(jFrame1,
                "<html><br><b>TicTacToe Version 3.0</b><br>"
                + "<br>This is a free/open programm<br>"
                + "<br>Developed by:<br>"
                + "<br><i>Oshoder</i> <br>"
                + "<i>Cevapci</i> <br> "
                + "<i>kinqqqqqq</i><br>"
                + "<br><small>Willi Graf Gymnasium</small></html>",
                "Über das Programm",
    ...
    private void HilfeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HilfeActionPerformed
        JOptionPane.showMessageDialog(jFrame1,
                "<html><br><b>Das Grundprinzip:</b><br>"
                + "<br>Es muss lediglich ein Spieler<br>"
                + "3 gleiche Objekte entweder<br>"
                + "Diagonal, Horizontal oder Vertikal anlegen<br>"
                + "wer zuerts dies erreicht, gewinnt !<br>"
                + "Kreuz fängt an...</html>",
                "Wie spielt man dieses Spiel",
                JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_HilfeActionPerformed

    private void agbstartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agbstartActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(jFrame1,
                "<html><br>Wir haben keine wirklichen AGBs<br></html>",
                "AGB",
                JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_agbstartActionPerformed

    private void spielenstartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_spielenstartActionPerformed
        // TODO add your handling code here:
        tictactoefeld.setVisible(true);
        quizfeld.setVisible(false);
    }//GEN-LAST:event_spielenstartActionPerformed

    //unlicensed Icon by Author: QuizAnswers (Src: http://goo.gl/EiZBmA)
    ...
    private javax.swing.JButton agbstart;
    ...
    private javax.swing.JButton spielenstart;
